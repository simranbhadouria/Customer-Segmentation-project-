...
Data Collection & Cleaning: Imported CSV data containing customer transactions — CustomerID, InvoiceDate, InvoiceNo, Quantity, UnitPrice.
...
Outcome:
Identified 4 customer segments (e.g., loyal, at-risk, new, big spenders). Provided insights for personalized marketing strategies.
